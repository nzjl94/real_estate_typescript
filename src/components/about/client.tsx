...
import {
	...
	useTheme,styled,RootState,IMAGE,TEXT,HEADER
} 									from "./header"
		...
		<div className="grid grid-flow-row gap-y-[60px]"> 
			...
			<div className="grid grid-flow-col gap-x-[50px]" >
				{data.map(({section1,section2,section3},index) => {
					return (
						<CleintContainer key={index} className="bg-gray-2 p-[50px] rounded-[12px] border-[1px] border-gray-1 grid grid-flow-row gap-y-[40px]" >
